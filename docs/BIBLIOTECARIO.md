...
2. Visitar los portales oficiales de UNESCO, BID y OCDE configurados; buscar novedades por tema y fecha. El script aporta estos portales, pero no descubre publicaciones automáticamente. Un agente de investigación con navegador realiza esta parte.
